...
declare class VariableProcessor {
     ...
     */
    renderAndAddUserDefinedVariable(site: string, name: string, value: any): void;
    /**
     ...
     */
    renderWithSiteVariables(contentFilePath: string, pageSources: PageSources, lowerPriorityVariables?: {
        [key: string]: any;
    }): string;
    /**
     ...
     */
    renderIncludeFile(filePath: string, pageSources: PageSources, node: DomElement, context: Context, asIfAt: string): {
