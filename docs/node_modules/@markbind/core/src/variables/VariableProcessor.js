...
const VariableRenderer_1 = __importDefault(require("./VariableRenderer"));
...
class VariableProcessor {
    ...
    baseUrlMap) {
        ...
        this.baseUrlMap.forEach((siteRootPath) => {
            ...
            this.variableRendererMap[siteRootPath] = new VariableRenderer_1.default(siteRootPath);
        });
    }
    /*
     * --------------------------------------------------
    ...
    static extractIncludeChildElementVariables(includeElement) {
        ...
        const includeElementAttribs = includeElement.attribs;
        includeElement.children.forEach((child) => {
            ...
            if (!variableName) {
                logger.warn(`Missing 'name' or 'id' in variable for ${includeElementAttribs.src}'s include in ${includeElementAttribs[constants_1.ATTRIB_CWF]}.\n`);
                return;
            }
