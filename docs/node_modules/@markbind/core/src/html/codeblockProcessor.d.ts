 ...
 */
export declare function highlightCodeBlock(node: DomElement): void;
/**
 ...
 */
export declare function setCodeLineNumbers(node: DomElement, showCodeLineNumbers: boolean): void;
